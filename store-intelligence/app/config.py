...
class Settings(BaseSettings):
    ...
    cors_origins: str = "http://localhost:5173,http://localhost:3000,https://purplle-tech-challenge-2026-3-git-main-nikitha-999s-projects.vercel.app,https://purplle-tech-challenge-2026-xi.vercel.app"  # NEW: configurable CORS
